...
class ShapeletTransform(_PanelToTabularTransformer):
        ...
        while case_idx < len(cases_to_visit):
            ...
            if candidate_starts_and_lens is None:
                candidate_starts_and_lens = [
                    ...
                    for length in self.shapelets_lengths
    ...
    def transform(self, X, y=None):
        ...
        # initialize the arrays that will hold the distances between the
        ...
        for i in range(0, len(_X)):
            ...
            for s in range(0, len(self.shapelets)):
                ...
                # array to hold the distances between the shapelet and
                # its potential occurences in this time series
                shapelet_distances = []
